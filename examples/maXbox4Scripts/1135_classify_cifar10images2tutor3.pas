unit classify_cifar10_images2lazTutor3;
...
{the rpblem(bug) is it predicts always a cat - solved!}
...
Form1:= TForm1.create(self);
 with form1 do begin
  setbounds(145, 486, 413, 440)
  Caption:= 'Form1 maXbox CAI_Classify'
  ClientHeight:= 430; ClientWidth:= 413;

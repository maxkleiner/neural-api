unit Uvisualcifar10test_mX4_13;
...
begin
  ...
  for NeuronCnt := Low(aImage) to High(aImage) do begin
...
begin
  ...
  //DisplayInputImage(csEncodeRGB, vDisplay);
    ...
    lbl7.caption:= cs10labels[(ImgVolumes[6].Tag)]
    ...
    lbl8.caption:=  cs10labels[(ImgVolumes[7].Tag)]  
    ...
    lbl9.caption:=  cs10labels[(ImgVolumes[8].Tag)]  
    ...
    lbl10.caption:=  cs10labels[(ImgVolumes[9].Tag)]  
...
with FrmVisualLearn do begin
  ...
  with imgsample4 do begin
   ...
   setbounds( 800, 132, 32, 32)
    ...
    lblchoice.caption:= 'this a class';
  end;
